...
lazy_static! {
    ...
    static ref CHANNEL_ACCOUNT_MODULE_V2: ModuleDefinition =
        make_module_definition!("../modules/channel_account_v2.mvir");
...
pub fn channel_account_module_v2() -> ModuleDefinition {
    CHANNEL_ACCOUNT_MODULE_V2.clone()
}
